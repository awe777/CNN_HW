...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.CNN_top_module \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../CNN_HW.srcs/sources_1/bd/CNN_top_module/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../CNN_HW.srcs/sources_1/bd/CNN_top_module/ipshared/70cf/hdl" \
       +incdir+"../../../../CNN_HW.srcs/sources_1/bd/CNN_top_module/ipshared/ec67/hdl" \
       +incdir+"../../../../CNN_HW.srcs/sources_1/bd/CNN_top_module/ipshared/70cf/hdl" \
       +incdir+"../../../../CNN_HW.srcs/sources_1/bd/CNN_top_module/ip/CNN_top_module_processing_system7_0_0" \
