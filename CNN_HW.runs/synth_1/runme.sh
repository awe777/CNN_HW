...
HD_PWD='D:/Documents/FPGA_Projects/CNN_HW/CNN_HW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CNN_top_module_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CNN_top_module_wrapper.tcl
