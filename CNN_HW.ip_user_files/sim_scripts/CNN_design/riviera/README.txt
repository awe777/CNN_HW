...
#
# Generated by export_simulation on Thu Feb 28 10:54:16 +0700 2019
#
################################################################################
...
'-reset_run' switch to the './CNN_design.sh' script.

./CNN_design.sh -reset_run
...
./CNN_design.sh -noclean_files

For more information on the script, please type './CNN_design.sh -help'.
